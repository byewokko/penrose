...
from drawing import pil_draw_simple as draw

"""
This module presents a very inefficient way to compute ROUGH Penrose tiling nodes from Pentagrid.
It works, but with terrible time complexity.
"""
